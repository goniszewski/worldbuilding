...
Aspects are not inherently malevolent — their motivations and thought processes are simply **beyond mortal comprehension**.

- **Not demons** — Demons are fragments of Aspects, not the Aspects themselves
- **Not gods** — They are not worshipped and do not demand veneration
- **Not predictable** — Their actions follow no discernible pattern mortals can anticipate
...
### Themes
- **Cosmic horror** — entities whose very nature defies understanding
- **Fragments of the divine** — demons as shed pieces of something greater
- **The price of power** — contact with Aspects transforms mortals

### Story Hooks
- A mage seeks to communicate directly with an Aspect (possible but dangerous)
- A cult worships Aspects as "lost gods" or "primordial beings"
- Someone claims an Aspect spoke to them in a dream
- A demon seeks to reunite with its parent Aspect

---

## TODO

- [ ] Develop the relationship between Aspects and gods/religions
- [ ] Create specific named Aspects
- [ ] Detail the layers of the Void
