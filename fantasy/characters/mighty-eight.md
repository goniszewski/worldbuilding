...
### The Gathering
A seeress named **Mira of the Pale Moon** gathered eight individuals:
- Each represented a different virtue
- Each possessed a unique gift
- Together, they could counter the Archmage's power

## The Eight

| Hero | Virtue | Gift | Role |
|------|--------|------|------|
| First | Wisdom | The Sight | Seer, strategist |
...
### Finding the Blade
The key to defeating the Archmage was **Soul Breaker** — only this weapon could sever his soul from his phylactery.

- **Fourth** tracked it to the Archmage's vault
- **Sixth** infiltrated the stronghold
- **Seventh** carried it to the final battle
...
- Three died in the initial assault
- The remaining five held him while Seventh prepared
- **Seventh** struck the killing blow
- **Second** and **Eighth** died holding the line
...
| Survivor | Fate |
|----------|------|
| First | Lived to old age, wrote the Chronicle |
| Fourth | Disappeared searching for other artifacts |
...
- He offered one of them a deal before the final battle
- His cult seeks to destroy their legacy
...
### Campaign Hooks
- **Descendant quest** — find a hidden bloodline member
- **Relic hunter** — recover the Eight's weapons
- **Revisionist history** — the Eight weren't heroes?
- **The survivor's secret** — one of them betrayed the mission
...
Heroes can:
- Be inspired by the Eight's courage
- Feel crushed by their legacy
- Discover uncomfortable truths about them

---

## TODO

- [ ] Develop individual character sheets for each of the Eight
- [ ] Create locations from their final battle
- [ ] Add specific artifacts they wielded
- [ ] Write their oaths and founding principles
- [ ] Explore their relationships with each other
