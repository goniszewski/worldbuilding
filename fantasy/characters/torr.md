...
| Trait | Description |
|-------|-------------|
| **Harsh** | Stern and unforgiving |
| **Prone to Violence** | Quick to conflict |
| **Honor-bound** | Despite his violence, followed a strict code |
| **Traditionalist** | Despised his siblings' marriage as "corruption" |
...
### Themes
- **Honor through violence** — is there honor in war?
- **Ancestral hatred** — inherited grudges spanning millennia
- **Physical transformation** — the body changed by magic, reflecting internal nature
...
- [ ] Develop Torr's specific beliefs/code of honor
- [ ] Create notable Naterian characters who embody his traits
- [ ] Add regional variations in how Torr is worshiped/remembered
