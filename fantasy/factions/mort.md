...
> "Topór i wiara." *(The axe and faith.)*
...
### The Five Clans Heritage

The Mort are divided into five clan-lines, each claiming descent from one of the original tribes:
1. **Klan Wilka** (Wolf Clan) — Scouts and hunters
2. **Klan Niedźwiedzia** (Bear Clan) — Heavy infantry
3. **Klan Orła** (Eagle Clan) — Rangers and pathfinders
4. **Klan Wilczycy** (She-Wolf Clan) — Female warriors
5. **Klan Burzy** (Storm Clan) — Shamans and berserkers

### The Trial of Fire

Before a warrior may wield a ceremonial war axe, they must survive the *Próba Ognia* (Trial of Fire):
- Three days without food or water
- Alone in the mountains
- Must return with a trophy from a predator they killed barehanded
- Failure means exile, not death — but death is considered an honor
...
- The price of rage — what happens when the fury turns inward?
- Faith as power and as prison
- Honor among those society considers "barbaric"
...
- Mort do not use siege weapons — they consider walls cowardly
- Children begin training with wooden axes at age 6
- The old gods' names have been deliberately forgotten by outsiders to weaken them
- A Mort warrior in their Fury is considered "touched by the gods" — harming them brings bad luck

## TODO

- [ ] Detail each of the Five Clans
- [ ] Create the old gods pantheon
- [ ] Develop the rivalry with Tiel
- [ ] Add Mort shaman/religious traditions
