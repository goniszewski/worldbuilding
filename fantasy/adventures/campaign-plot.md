...
A tense atmosphere permeates the lands of humans, elves, dwarves, and naters. Increasingly bold attacks by human (with small elven admixture) extremists — and the helplessness of human rulers — grate on the other races. Targets include not only humans, but primarily elves, with increasingly daring strikes against dwarves and naters.
...
After some time, the hero discovers that **elves and naters had been quietly discussing a possible occupation of human territories** to solve the problem and bring lasting peace. When human rulers learn of this, they begin preparing for war.
...
After the betrayal, an important clue emerges — **the cult is preparing for a kind of "holy day"**, the so-called **Revelation**. Zealots begin using an even more powerful explosive based on **black ore** — extremely rare. This can only mean one thing: **the cultists have found one of the Black Stones of Ur**.
...
**If the hero believes in his good intentions** (eternal peace, watching over the world) — they will create a god together. The hero will be his prophet, their souls connected by an unbreakable thread.

**If he refuses** — it will be as it was.
...
- [ ] Expand the Brotherhood storyline — who founded it? Why was it betrayed?
- [ ] Add specific characters from the Mighty Eight
- [ ] Expand the Soul Breaker's history — who created it?
- [ ] Add maps of key locations
- [ ] Prepare alternative endings (beyond god/not-god)
