---
name: Modern Earth Universe
type: index
category: meta
summary: "Quick navigation index for the Modern Earth setting — the Reopening, the dead world, and the war for the threshold."
---

# Modern Earth Universe

> Present-day Earth. The ancient portals have woken, Hell turns out to be a ruined planet, and humanity is holding the line — for now.

**[Master Bible](BIBLE.md)** — Full setting reference
...
| Topic | Summary |
| --- | --- |
| [The Reopening](lore/the-reopening.md) | Day One, the March, the Scouring, the Crossing |
| [The Cycles](lore/the-cycles.md) | The recurring ends of the world across tens of thousands of years |
...
| [The Far Side](places/the-far-side.md) | The dead world | Ash, cold ruins, and two human outposts |

### Creatures

| Creature | Classification | Notes |
| --- | --- | --- |
| [Devil-Kind](creatures/devil-kind.md) | Remnant species & war-forms | Chaff, Towers, Kites, Burrowers, Choristers — and the Bound |

### Characters

| Character | Role | Affiliation |
| --- | --- | --- |
| [Gen. Adaora Mensah](characters/adaora-mensah.md) | Supreme Commander | Joint Portal Command |
| [Dr. Emrys Lindqvist](characters/emrys-lindqvist.md) | Linguist, Babel Initiative lead | JPC Research |
| [Maj. Katarzyna Nowak](characters/katarzyna-nowak.md) | Special operations, far-side command | Gate Alpha perimeter |
| [He-Who-Sifts-Ash](characters/he-who-sifts-ash.md) | Hell-lord of the Cinder Flats | The first devil to speak |

---

## Campaign Summary

**Setting**: Present-day Earth, mid-2034 — three years into the Reopening.

**Core Conflict**: Nine active gates under military containment; two held open as doors into the enemy's world. On one side, the fractured remnant of a dead civilization. On the other, the Observers — and the quiet question of what humanity's rise will cost.

**Key Hook**: The first translated sentence from a captured Chorister — *"We are the ash that remembers fire."* Humanity is beginning to understand what that means.
