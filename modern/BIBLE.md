---
name: Modern Earth Bible
type: guide
category: meta
summary: "Core reference bible for the Modern Earth setting — the Reopening, the dead world behind the gates, and the war for the threshold."
---
...
| 2034 | **The Lattice** — Project Lattice reconstructs the anchors' placement pattern; 85 anchors total, 38 never woke — most destroyed, 6 dormant (D-sites) confirmed on Earth. |
...
The creatures behind the gates are not one species but the **remnant of a civilization** — the Ash-Born, survivors of a world killed by war. Most forms humans met are war-forms; some are not devils at all, but **the Bound**: enslaved beings from worlds the devils conquered. See [Devil-Kind](creatures/devil-kind.md) for the full bestiary.
...
### Themes to Explore
- The end of the world as a **recurring event** — apocalypse as history, not prophecy.
- **Myth vs. truth** — every religion's Hell and angels are war correspondents' reports from older cycles.
- The **military as civilization's edge** — what war does to a species when the enemy is endless and the front is a doorway.
- **The ceiling** — civilizations that police other civilizations; the Threshold as the ultimate cage.
- **Language as power** — a tongue with no future tense shapes how its speakers plan, fight, and surrender.

### Story Hooks
- The first hell-lord offers humanity a **truce against the Observers** — is he honest, pragmatic, or bait?
- A gate that should be dead **wakes again** inside the containment zone.
...
- [Universe Index](_index.md) — quick navigation
- [Fantasy Universe](../fantasy/BIBLE.md) — the other worlds of this library
- [Sci-Fi Universe](../scifi/BIBLE.md) — humanity's far future
